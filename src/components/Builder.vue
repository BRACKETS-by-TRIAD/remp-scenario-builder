...
import joint_css from 'jointjs/css/layout.css';
import joint_css_theme from 'jointjs/css/themes/default.css';
...
export default {
  ...
  mounted() {
        ...
        var paper = new joint.dia.Paper({
            el: $('#builder'),
            model: graph,
            width: $(window).width(), height: $(window).height(), gridSize: 5,
            snapLinks: true,
            linkPinning: false,
